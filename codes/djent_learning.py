...
model.add(SimpleRNN(units=32, activation=None, return_sequences=True, return_state=False))  # able to add more layers
model.add(Dropout(0.2))  # by repeating these two lines
model.add(SimpleRNN(units=64, activation=None, return_sequences=False, return_state=False))
